...
<html>
	...
	<body>
			...
			<div class="main-slider">
				<div id="main-slider-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						...
						<div class="item">
							<img src="images/parallax-background-2.jpg" alt="bedroom2">
							<div class="background-overlay"></div>
						</div> <!-- item -->
						<div class="item">
			...
			<div class="agent-section-inner">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4 col-md-4">
							<img src="images/agent1.png" alt="agent" class="agent-img2">
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 agent-detail">
							<div class="vertical-distance-60"></div>
							<div class="row">
		...
		<!-- <section class="our-partner">
			<div class="vertical-distance-40"></div>
			<div class="container">
				<h2 class="main-title text-center ">Our Partners</h2>
				<p class="sub-title text-center">Meet to our partners.</p>
				<div class="vertical-distance-80"></div>
				<a href="#">
					<figure>
						<img src="images/audiojungle.png" alt="audiojungle" />
					</figure>
				</a>
				<a href="#">
					<figure>
						<img src="images/codecanyon.png" alt="codecanyon" />
					</figure>
				</a>
				<a href="#">
					<figure>
						<img src="images/photodune.png" alt="photodune" />
					</figure>
				</a>
				<a href="#">
					<figure>
						<img src="images/themeforest.png" alt="themeforest" />
					</figure>
				</a>
				<a href="#">
					<figure>
						<img src="images/videohive.png" alt="videohive" />
					</figure>
				</a>
			</div>
			<div class="vertical-distance-80"></div>
		...
		<section class="contact-us-section-background" id="contact-section">
		...
		<div class="modal fade" id="book_car_modal" tabindex="-1" role="dialog">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<h3>Location &amp; Date</h3>
								<div class="vertical-distance-40"></div>
								<div class="book-time-location">
									<div class="media">
										<div class="media-left media-middle">
											<i class="fa fa-calendar" aria-hidden="true"></i>
										</div>
										<div class="media-body">
											<h6 class="media-heading">Pick-Up Date/Time</h6>
											<p class="pickuptime_label"> </p>
										</div>
									</div>
									<div class="media">
										<div class="media-left media-middle">
										...
										<div class="media-body">
											<h6 class="media-heading">Drop-Off Date/Time</h6>
											<p class="dropofftime_label"> </p>
										</div>
									</div>
									<div class="media">
										<div class="media-left media-middle">
										...
										<div class="media-body">
											<h6 class="media-heading">Pick-Up Location</h6>
											<p class="pickuppoint_label"> </p>
										</div>
									</div>
									<div class="media">
										<div class="media-left media-middle">
										...
										<div class="media-body">
											<h6 class="media-heading">Drop-Off Location</h6>
											<p class="dropoffpoint_label"> </p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6">
								<h3>CAR :- <span class="car_title_label">VW Golf VII</span></h3>
								<img src="images/blog.jpg" class="full-width car_image_path" alt="Car Name">
							</div>
						</div>
						<form action="#" method="post" name="car-booking-form">
							<h3>Personal Detail</h3>
							<div class="row">
								<input type="hidden" name="carname_hidden">
								<input type="hidden" name="pickuptime_hidden">
								<input type="hidden" name="pickuppoint_hidden">
								<input type="hidden" name="dropofftime_hidden">
								<input type="hidden" name="dropoffpoint_hidden">
								<div class="col-xs-12 col-sm-4 col-md-4">
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
									<input type="text" name="note" placeholder="Special Note">
								</div>
								<div class="col-xs-12 col-sm-4 col-md-4 col-sm-offset-8">
									<input type="submit" name="booknow" value="Book Now" class="booking_car">
								</div>
								<div class="col-xs-12 col-sm-12 col-md-12">
									<div class="alert-container-book"> </div>
								</div>
							</div>
						</form>
					</div>
